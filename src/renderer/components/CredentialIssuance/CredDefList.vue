    ...
    <el-collapse v-model="expanded_items">
      <ul class="list">
        <el-collapse-item
          ...
          v-bind:title="'\xa0\xa0\xa0\xa0\xa0'+creddef.cred_def_id"
          :name="creddef.cred_def_id"
          :key="creddef.cred_def">
          <el-row :key="creddef.cred_def" style="padding-left: 20px">
            <ul>
